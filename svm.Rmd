...
zwei
Einflussgrößen beschrieben sind betrachtet.

## Hyperebenen
In diesem einfachen Fall existieren
bereits viele
...
werden können, bei mehr als drei Dimensionen allerdings
mehrdimensionale Vektoren sind.
...
der Erkennung von Fingerabdrücken[^2] oder Erkennung von Emotionen
einer Testperson anhand des Pulses und des Alters.[^3] Außerdem werden
SVM häufig für die Klassifikation von Handschrift verwendet.[^4]
