...
1. Definition der trennenden Hyperebene $\mathcal{H}:=\{x\in\mathbb{R}^n\mid<w,x>+b=0\}$

+ mit $w\in\mathbb{R}^n$ als zu $\mathcal{H}$ orthogonal Vektor
+ und $b\in\mathbb{R}$ als Verschiebung
2. Da dies noch keine eindeutige Definition der Hyperebene ist, denn $$, muss diese noch normiert werden
